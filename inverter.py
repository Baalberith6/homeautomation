...
async def publish(client):
    ...
    while True:
        try:
            ...
            client.publish("home/FVE/load_p/1", runtime_data["load_p1"] + runtime_data["backup_p1"], qos=2, properties=publishProperties)
            client.publish("home/FVE/load_p/2", runtime_data["load_p2"] + runtime_data["backup_p2"], qos=2, properties=publishProperties)
            client.publish("home/FVE/load_p/3", runtime_data["load_p3"] + runtime_data["backup_p3"], qos=2, properties=publishProperties)
